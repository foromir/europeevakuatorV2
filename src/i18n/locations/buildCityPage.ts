...
type CityPageCopy = {
  seoTitle: (city: string, inCountry: string) => string;
  seoDescription: (city: string, inCountry: string) => string;
  ogTitle: (city: string, inCountry: string) => string;
  ogDescription: (city: string, inCountry: string) => string;
  twitterTitle: (city: string) => string;
  twitterDescription: (city: string, inCountry: string) => string;
  badge: (city: string) => string;
  titleRest: (city: string) => string;
  subtitle: string;
  text: (city: string, inCountry: string) => string;
  slideAlts: (city: string) => readonly string[];
...
const COPY: Record<Locale, CityPageCopy> = {
  ru: {
    seoTitle: (city, inCountry) => `Эвакуатор в ${city} 24/7 – Помощь на дороге ${inCountry}`,
    seoDescription: (city, inCountry) =>
      `Круглосуточный эвакуатор в ${city}: помощь на дороге, эвакуация и перевозка авто ${inCountry} и в Украину. Быстрый выезд, прозрачные цены, без скрытых доплат.`,
    ogTitle: (city, inCountry) => `Эвакуатор в ${city} 24/7 – Помощь на дороге ${inCountry}`,
    ogDescription: (city, inCountry) =>
      `Круглосуточный эвакуатор в ${city}: эвакуация и перевозка авто ${inCountry}. Быстрый выезд, прозрачные цены.`,
    twitterTitle: (city) => `Эвакуатор в ${city} 24/7`,
    twitterDescription: (city, inCountry) =>
      `Эвакуатор в ${city}: помощь на дороге и перевозка авто ${inCountry} 24/7.`,
    badge: (city) => `${city} — выезд 24/7`,
    titleRest: (city) => `Эвакуатор в ${city}`,
    ...
    slideAlts: (city) => [
      `Эвакуатор в ${city} — круглосуточный выезд`,
      `Эвакуация и перевозка авто в ${city}`,
      `Погрузка автомобиля на эвакуатор в ${city}`,
    ],
  ...
  en: {
    seoTitle: (city, inCountry) => `Tow Truck in ${city} 24/7 – Roadside Assistance ${inCountry}`,
    seoDescription: (city, inCountry) =>
      `24/7 tow truck in ${city}: roadside assistance, car recovery and transport ${inCountry} and to Ukraine. Fast response, transparent pricing, no hidden fees.`,
    ogTitle: (city, inCountry) => `Tow Truck in ${city} 24/7 – Roadside Assistance ${inCountry}`,
    ogDescription: (city, inCountry) =>
      `24/7 tow truck in ${city}: car recovery and transport ${inCountry}. Fast response, transparent pricing.`,
    twitterTitle: (city) => `Tow Truck in ${city} 24/7`,
    twitterDescription: (city, inCountry) =>
      `Tow truck in ${city}: roadside assistance and car transport ${inCountry} 24/7.`,
    badge: (city) => `${city} — 24/7 dispatch`,
    titleRest: (city) => `Tow Truck in ${city}`,
    ...
    slideAlts: (city) => [
      `Tow truck in ${city} — 24/7 dispatch`,
      `Car recovery and transport in ${city}`,
      `Loading a car onto a tow truck in ${city}`,
    ],
  ...
  de: {
    seoTitle: (city, inCountry) => `Abschleppdienst in ${city} 24/7 – Pannenhilfe ${inCountry}`,
    seoDescription: (city, inCountry) =>
      `Abschleppdienst in ${city} rund um die Uhr: Pannenhilfe, Abschleppen und Autotransport ${inCountry} und in die Ukraine. Schnelle Anfahrt, transparente Preise, keine versteckten Kosten.`,
    ogTitle: (city, inCountry) => `Abschleppdienst in ${city} 24/7 – Pannenhilfe ${inCountry}`,
    ogDescription: (city, inCountry) =>
      `Abschleppdienst in ${city}: Autotransport ${inCountry} rund um die Uhr. Schnelle Anfahrt, transparente Preise.`,
    twitterTitle: (city) => `Abschleppdienst in ${city} 24/7`,
    twitterDescription: (city, inCountry) =>
      `Abschleppdienst in ${city}: Pannenhilfe und Autotransport ${inCountry} 24/7.`,
    badge: (city) => `${city} — Einsatz 24/7`,
    titleRest: (city) => `Abschleppdienst in ${city}`,
    ...
    slideAlts: (city) => [
      `Abschleppdienst in ${city} — Einsatz rund um die Uhr`,
      `Abschleppen und Autotransport in ${city}`,
      `Beladung eines Fahrzeugs auf den Abschleppwagen in ${city}`,
    ],
  ...
  uk: {
    seoTitle: (city, inCountry) => `Евакуатор у ${city} 24/7 – Допомога на дорозі ${inCountry}`,
    seoDescription: (city, inCountry) =>
      `Цілодобовий евакуатор у ${city}: допомога на дорозі, евакуація та перевезення авто ${inCountry} та в Україну. Швидкий виїзд, прозорі ціни, без прихованих доплат.`,
    ogTitle: (city, inCountry) => `Евакуатор у ${city} 24/7 – Допомога на дорозі ${inCountry}`,
    ogDescription: (city, inCountry) =>
      `Цілодобовий евакуатор у ${city}: евакуація та перевезення авто ${inCountry}. Швидкий виїзд, прозорі ціни.`,
    twitterTitle: (city) => `Евакуатор у ${city} 24/7`,
    twitterDescription: (city, inCountry) =>
      `Евакуатор у ${city}: допомога на дорозі та перевезення авто ${inCountry} 24/7.`,
    badge: (city) => `${city} — виїзд 24/7`,
    titleRest: (city) => `Евакуатор у ${city}`,
    ...
    slideAlts: (city) => [
      `Евакуатор у ${city} — цілодобовий виїзд`,
      `Евакуація та перевезення авто у ${city}`,
      `Завантаження автомобіля на евакуатор у ${city}`,
    ],
...
export function buildLocationCityPage(
  ...
  const hubs = country.directionHubs[locale].filter((hub) => hub !== cityName);
  const directions = hubs.slice(0, 4).map((hub) => `${cityName} — ${hub}`);

  return {
    seo: {
      title: copy.seoTitle(cityName, inCountry),
      description: copy.seoDescription(cityName, inCountry),
      canonicalPath: path,
      ogTitle: copy.ogTitle(cityName, inCountry),
      ogDescription: copy.ogDescription(cityName, inCountry),
      ogUrlPath: path,
      twitterTitle: copy.twitterTitle(cityName),
      twitterDescription: copy.twitterDescription(cityName, inCountry),
      ogImagePath: GALLERY_IMAGES[imageIndex % GALLERY_IMAGES.length],
    },
    evacuation: {
      ...evacuationShared,
      badge: copy.badge(cityName),
      titleRest: copy.titleRest(cityName),
      subtitle: copy.subtitle,
      text: copy.text(cityName, inCountry),
      slideAlts: copy.slideAlts(cityName),
    },
    landing: {
      directions: {
        title: copy.directionsTitle(cityName),
        lead: copy.directionsLead(cityName, inCountry),
        list: directions,
